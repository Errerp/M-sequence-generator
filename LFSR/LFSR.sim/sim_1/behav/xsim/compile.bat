...
REM
REM Generated by Vivado on Wed Jun 25 12:10:39 +0300 2025
...
echo "xvlog --incr --relax -L uvm -prj LDSR_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj LDSR_tb_vlog.prj -log xvlog.log
